...
namespace ERM_HSYT.Droid
{
    ...
    public class ExtendedCarouselViewRenderer : CarouselViewRenderer
    {
        ...
        //private void ChildViewAdded ( object sender, ChildViewAddedEventArgs e)
        //{
        //    var view = e.Child.GetType();
        //    if (e.Child.GetType() == typeof(Android.Widget.TextView))
        //    {
        //        var textView = (Android.Widget.TextView)e.Child;
        //        var spacefont = Typeface.CreateFromAsset(Forms.Context.ApplicationContext.Assets, "TIMES.TTF");
